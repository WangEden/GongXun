...
from VisionDuoMa import *
from VisionJingJIaGong import *
from VisionPlate import *
from VisionZanCun import *
import time
import subprocess
...
def task2():
    ...
    # 获取物料摆放顺序
    getItemBaiFan(thresholdItem)

    # 在暂存区校准
    fineTuneRing3(thresholdRing, thresholdItem, ringRate)
